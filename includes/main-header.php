...
<div class="search-area">
    <form name="search" method="post" action="search-result.php">
        <div class="control-group">
            ...
            <input class="search-field" style="width: calc(100% - 55px);padding-right: 40px;margin:0px;!important"placeholder="Search here..." name="product" required="required" />

            <button class="search-button" style="border:0px;!important" type="submit" name="search" ></button>    
	...
	?>
				...
				<div class="cart-item product-summary">
					<div class="row">
						...
						<div class="col-xs-7">
							...
							<div class="price">RM <?php echo ($row['productPrice']); ?>*<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?></div>
						</div>
			...
			<div class="clearfix cart-total">
				<div class="pull-right">
						...
						<span class="text">Item Total :</span><span class='price'>RM <?php echo $_SESSION['tp']="$totalprice"; ?></span>
