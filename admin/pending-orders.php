...
if (strlen($_SESSION['alogin']) == 0) {
	...
	<head>
		...
		<title>Admin| In Process Orders</title>
									...
									<table cellpadding="0" cellspacing="0" border="0"
										...
										<thead>
											<tr>
												<th>Order ID#</th>
												<!-- <th> Name</th> -->
												<th width="50">Receiver Name/Email/Contact no</th>
										...
										<tbody>
											...
											orders.orderStatus,
											orders.grandtotal,
											orders.shippingReceiver AS username,
											users.email AS useremail,
											orders.shippingPhone AS usercontact,
											orders.shippingAddress AS shippingaddress,
											orders.shippingCharge AS shippingcharge,
											...
											while ($row = mysqli_fetch_array($query)) {
												...
												<tr>
													...
													<!-- <td></td> -->
													<td><?php echo htmlentities($row['username']); ?><br><?php echo htmlentities($row['useremail']); ?></br><?php echo htmlentities($row['usercontact']); ?>
													</td>
