								...
								<div class="module-body table">
									...
									<table cellpadding="0" cellspacing="0" border="0"
										...
										<tbody>
											...
											<?php $query = mysqli_query($con, "select products.*,category.categoryName,subcategory.subcategory from products join category on category.id=products.category join subcategory on subcategory.id=products.subCategory 	WHERE subcategory.SubStatus = 'Active'");
											$cnt = 1;
