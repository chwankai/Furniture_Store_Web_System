...
if (strlen($_SESSION['login']) == 0) {
	...
	if (isset($_POST['update']))//update user info and profile
	{
		$name = $_POST['name'];
	...
	<head>
		...
		<script type="text/javascript">
			function valid()//checking validation of change password after user login
			{
				if (document.chngpwd.cpass.value == "")//check password field is empty or not
				{
					...
					return false;
				} else if (document.chngpwd.newpass.value.length < 8) {
					alert("Password must be at least 8 characters long.");
					document.chngpwd.newpass.focus();
					return false;
				} else if (!/[a-z]/.test(document.chngpwd.newpass.value)) {
					...
					document.chngpwd.newpass.focus();
					return false;
				} else if (!/[0-9]/.test(document.chngpwd.newpass.value)) {// Check if new password includes at least one number
					alert("Password must include at least one number.");
					document.chngpwd.newpass.focus();
					return false;
				}else if (!/[!@#$%^&*(),.?":{}|<>]/.test(document.chngpwd.newpass.value)) { // Check if new password includes at least one symbol
	...
	.toggle-password-checkbox {
		...
		.toggle-password-checkbox:hover {
        color: white;
	...
	<body class="cnt-home">
										...
										<div class="panel-body">
											<div class="row">
												...
												<div class="col-md-12 col-sm-12 already-registered-login">
													...
													<?php
													$query = mysqli_query($con, "select * from users where id='" . $_SESSION['id'] . "'");//use to display current user info which revtrive from database
														...
														<form class="register-form" role="form" method="post">
															<div class="form-group">
																...
																<input type="text"
																	...
																	required="required" pattern="[a-zA-Z][a-zA-Z0-9\s]*"
																	title="Please enter a valid name (letters & numbers only)">
															</div>
															<div class="form-group">
																<label class="info-title" for="birthday">Day of Birth
																	<span>*</span></label>
																<input type="date"
																	class="form-control unicase-form-control text-input"
																	id="birthday" value="<?php echo $row['birthday']; ?>"
																	readonly>
															</div>
															<div class="form-group">
															...
															<div class="form-group">
																...
																<input type="text"
																	...
																	value="+<?php echo $row['contactno']; ?>" minlength="11"
																	maxlength="12">
															</div>
															<button type="submit" name="update"
																class="btn-upper btn btn-primary checkout-page-button">Update</button>
														</form>
													<?php }//end of while to revtrivee user info  ?>
												</div>
								...
								<div class="panel panel-default checkout-step-02">
									...
									<div id="collapseTwo" class="panel-collapse collapse">
										<div class="panel-body">
											...
											<form action="change-p.php" class="register-form" role="form" method="post"
												...
												<div id="message">
													...
													<p id="capital" class="invalid">At least <b>capital (uppercase)</b>
														letter</p>
													<p id="number" class="invalid">At least <b>number</b></p>
													<p id="length" class="invalid">Minimum <b>8 characters</b></p>
													<p id="special" class="invalid">At least <b>one special character</b>
													</p>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<input type="password"
														...
														<button  type="button" id="toggle-password-checkbox" class="toggle-password-checkbox">Show Passwords</button>
												</div>
		...
		<script>
			...
			document.getElementById('toggle-password-checkbox').addEventListener('click', function() {
            const passwordFields = ['cpass','newpass', 'cnfpass'];
			...
			this.textContent = this.textContent === 'Hide Passwords' ? 'Show Passwords' : 'Hide Passwords';
        });
		</script>
	</body>
