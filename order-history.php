...
if (strlen($_SESSION['login']) == 0) {
	echo '<script>alert("Please login first to see your order history.");window.location.href = "login.php";</script>';
								...
								<form name="cart" method="post">
									...
									<table class="table table-bordered">
										...
										<tbody>
											...
											<?php $query = mysqli_query($con, "select orders.subtotal, orders.shippingCharge as shippingcharge, orders.grandtotal, orders.paymentMethod as paym,orders.orderDate as odate,orders.id as orderid ,orders.orderStatus as status from orders where orders.userId='" . $_SESSION['id'] . "' and orders.paymentMethod is not null ORDER BY orderid DESC;");
											$cnt = 1;
