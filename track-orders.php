		...
		<div class="container">
			<div class="track-order-page inner-bottom-sm">
				<div class="row" style=" display: flex; justify-content: center;">
					<div class="col-md-5" style="border:2px solid #f39c13;border-radius:20px;">
						<br>
						<h2>Track your Order</h2>
						<span class="title-tag inner-top-vs">Please enter your Order ID. Order ID was given to you in
							the confirmation email you have received. </span>
						<form class="register-form outer-top-xs" role="form" method="post" action="order-details.php">
							...
							<button type="submit" name="submit" class="btn-upper btn btn-primary checkout-page-button"
								style="display: block; margin: 0 auto;">Track</button><!-- Apply inline style for centering -->
						</form>
						<br>
						<br>
					</div>
